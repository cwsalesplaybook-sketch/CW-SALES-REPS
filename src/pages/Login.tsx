...
function Background() {
  return (
    ...
    >
      ...
      <path d="M 130 90 Q 340 40 540 180" fill="none" stroke="#9333ea" strokeWidth="1.8" strokeDasharray="6,10" opacity="0.20"/>
      <path d="M 100 370 Q 200 500 380 520" fill="none" stroke="#9333ea" strokeWidth="1.8" strokeDasharray="6,10" opacity="0.16"/>
      ...
      <path d="M 1310 100 Q 1400 200 1380 350" fill="none" stroke="#9333ea" strokeWidth="1.8" strokeDasharray="6,10" opacity="0.18"/>
      <path d="M 1370 460 Q 1300 560 1150 540" fill="none" stroke="#9333ea" strokeWidth="1.8" strokeDasharray="6,10" opacity="0.15"/>
    </svg>
  );
}
    ...
    >
      ...
      <div className="relative flex flex-col items-center w-full max-w-[440px] px-5" style={{ zIndex: 2 }}>
        ...
        <p className="text-[14px] text-white/65 text-center mb-7">
          Canal exclusivo{' '}
          <span className="font-bold" style={{ color: '#f59e0b' }}>Cardapio Web</span>
        </p>
        ...
        >
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <span className="text-[12px] font-medium" style={{ color: 'rgba(255,255,255,0.30)' }}>
              Acesso exclusivo para representantes de canal
            </span>
            <span style={{ color: 'rgba(255,255,255,0.30)', fontSize: 13 }}>🔒</span>
          </div>

          {erro && (
            <p className="mt-4 text-[12px] text-center rounded-xl px-4 py-2"
